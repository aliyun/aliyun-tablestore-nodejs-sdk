...
TableStore.SequentialExecutor = TableStore.util.inherit({
   ...
   *
   * @param listeners [map<String,Array<Function>>, TableStore.SequentialExecutor]
   *   a list of events and callbacks, or an event emitter object
   *   containing listeners to add to this emitter object.
   * @return [TableStore.SequentialExecutor] the emitter object, for chaining.
   ...
   *   var emitter1 = new TableStore.SequentialExecutor();
   *   emitter1.on('event1', function() { ... });
   *   emitter1.on('event2', function() { ... });
   *   var emitter2 = new TableStore.SequentialExecutor();
  ...
  addListeners: function addListeners(listeners) {
    ...
    TableStore.util.each(listeners, function(event, callbacks) {
      if (typeof callbacks === 'function') callbacks = [callbacks];
      TableStore.util.arrayEach(callbacks, function(callback) {
...
TableStore.SequentialExecutor.prototype.addAsyncListener = TableStore.SequentialExecutor.prototype.onAsync;
